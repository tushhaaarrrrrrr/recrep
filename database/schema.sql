...
CREATE TABLE IF NOT EXISTS mall_shop (
    ...
    amount_of_shops INTEGER NOT NULL,
    total_amount NUMERIC NOT NULL,
    payment_frequency TEXT NOT NULL CHECK (payment_frequency IN ('daily', 'weekly', 'monthly', 'yearly')),
    paid_periods INTEGER NOT NULL DEFAULT 1 CHECK (paid_periods >= 1),
    banner_color TEXT,
    shop_number TEXT,
    notes TEXT,
    paid_until DATE,
    next_due_date DATE,
    last_due_alert_for DATE,
    last_overdue_alert_for DATE,
    screenshot_urls TEXT NOT NULL,
    status TEXT DEFAULT 'pending',
    approved_by BIGINT,
    approved_at TIMESTAMP,
